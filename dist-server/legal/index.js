...
const OVERRIDE_FILE = { privacy: 'privacy-policy.md', terms: 'terms-of-service.md' };
export function parseLegalKind(value) {
    const v = value.trim().toLowerCase();
    return v === 'privacy' || v === 'terms' ? v : undefined;
}
export function legalDigest(markdown) {
    return 'sha256:' + createHash('sha256').update(markdown.replace(/\r\n/g, '\n')).digest('hex');
}
export function loadLegalDocument(dataDir, kind) {
