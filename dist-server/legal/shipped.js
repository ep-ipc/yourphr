/**
 * The shipped legal documents (yourphr#596) — the Privacy Policy and Terms of Service exactly as the
 * product repository ships them in backend/pkg/legal/*.md. Kept as string constants so the build
 * carries them without an asset step; regenerate from the product repository when those change
 * (the digest served to readers changes with every byte, see backend/pkg/legal/README.md).
 */
export const SHIPPED_PRIVACY_POLICY = `# Privacy Policy — YourPHR
...
`;
export const SHIPPED_TERMS_OF_SERVICE = `# Terms of Service — YourPHR
...
These Terms cover use of the YourPHR software and [yourphr.org](https://yourphr.org).

By using either, you agree to these Terms and the Privacy Policy. If you do not agree, do not use them.

---

## Software license

YourPHR is distributed under the [GNU GPL v3](https://github.com/jwilleke/yourphr/blob/main/LICENSE.md). Rights to use, modify, and redistribute the code are defined by the GPL; these Terms do not restrict those rights.
