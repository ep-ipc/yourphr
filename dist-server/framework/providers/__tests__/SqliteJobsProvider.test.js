...
let db;
let jobs;
const job = (sourceId, outcome, error = '') => ({ sourceId, outcome, received: 2, created: 1, updated: 1, error, startedAt: 10, finishedAt: 12 });
beforeEach(async () => {
...
//# sourceMappingURL=SqliteJobsProvider.test.js.map