...
describe('FilesystemBackupProvider — artifacts on a folder', () => {
    it('prepares a destination, lists only our artifacts newest first, resolves safe names only, prunes by count', async () => {
        ...
        for (const n of ['2026-01-01T00-00-00Z-backup.db', '2026-01-03T00-00-00Z-backup.db', '2026-01-02T00-00-00Z-backup.db', 'notes.txt'])
            writeFileSync(join(dest, n), 'x');
...
//# sourceMappingURL=FilesystemBackupProvider.test.js.map