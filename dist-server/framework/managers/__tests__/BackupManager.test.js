...
import { BackupManager, applyStagedRestore } from '../BackupManager.js';
import { FakeBackupProvider } from '../../providers/__tests__/FakeBackupProvider.js';
import { NullBackupProvider } from '../../providers/BaseBackupProvider.js';
...
let alice;
let clock;
async function boot(provider = store, env = { YOURPHR_BACKUP_ENCRYPTION_KEY: 'travel-key' }) {
    engine = new Engine();
...
//# sourceMappingURL=BackupManager.test.js.map