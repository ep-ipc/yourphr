...
import { BaseGlossaryProvider, NullGlossaryProvider } from '../../providers/BaseGlossaryProvider.js';
const CREATININE = {
...
class ScriptedLookup extends BaseGlossaryProvider {
    ...
    answer = CREATININE;
    fail = false;
    async explain(code, oid) {
        this.calls.push(`${code}|${oid}`);
        if (this.fail)
            throw new Error('MedlinePlus is unreachable');
        return this.answer;
    }
}
...
//# sourceMappingURL=GlossaryManager.test.js.map