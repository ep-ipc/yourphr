...
| [`chat.md`](chat.md) | The optional chat feature ([#594](https://github.com/jwilleke/yourphr/issues/594)): the Typesense sidecar, pointing it at your own language model, the create-once conversation model, indexing and backfill, and why the sidecar's port is not published. |
