...
| [`upgrading-v1-to-v2.md`](upgrading-v1-to-v2.md) | Go → TypeScript for anyone self-hosting who is __not__ on Kubernetes: stop v1, migrate a read-only copy, start v2, and how to go back. The rollback works because v1's data is never written to. |
