...
| [`chat.md`](chat.md) | The optional chat feature ([#594](https://github.com/jwilleke/yourphr/issues/594)): pointing it at your own language model, how retrieval works without embeddings, how many records an answer draws on, and the isolation guarantees between accounts. |
