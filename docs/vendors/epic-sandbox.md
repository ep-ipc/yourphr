...
__Register at:__ <https://fhir.epic.com> — self-register a patient-facing app to get a non-production `client_id`; no approval gate. Save it to `private/secrets.md`.
