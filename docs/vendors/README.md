...
| **Oracle Health (Cerner)** | public / PKCE | `nancysmart` / `Cerner01` | ✅ **works** (2026-06-18+) — imports records; long/slow sync is normal; needs pinned patient-authorize override + enumerated v2 `.rs` scopes + offline app (see below) |
