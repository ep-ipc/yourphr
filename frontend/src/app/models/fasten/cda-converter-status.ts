...
export interface CDAConverterStatus {
  // yourphr.cda-converter.enabled — the on/off switch on its own.
  enabled: boolean;
  ...
  ready: boolean;
  // Operator-facing setup steps (the converter service + the two Admin -> Configuration settings), rendered verbatim
