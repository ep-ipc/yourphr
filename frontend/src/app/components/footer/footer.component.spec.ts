...
describe('FooterComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    apiSpy.getPublicInstanceInfo.and.returnValue(of({ name: '', contact_email: '', contact_url: '', theme: '', demo_enabled: false, demo_admin_enabled: false, demo_admin_session: false, signup_enabled: true }));
