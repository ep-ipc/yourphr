...
**This directory is intentionally almost empty in git.** The `.db` file is a build artifact, produced
...
The seed contains **synthetic records only** and **no admin account**. The image is public, so a baked
